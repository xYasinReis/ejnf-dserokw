 ...
 if (!message.member.hasPermission("BAN_MEMBERS")) 
{
    ...
    .setColor('BLACK')
    .setDescription('**<a:unlem:814527254029402193> Bunu yapabilmek için gerekli yetkiye sahip değilsiniz! <a:unlem:814527254029402193>**')
   .setTimestamp() 
    .setFooter(`Laury Ban Sistemi`)
  ...
  .addField('<a:unlem:814527254029402193> Uyarı ', '`unban`komutu özel mesajlarda kullanılamaz.')
